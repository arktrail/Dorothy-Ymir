...
SECTION_PREDICT_RESULT_FILENAME = 'probability_1st.csv'
CLASS_PREDICT_RESULT_FILENAME = 'probability_2nd.csv'
SUBCLASS_PREDICT_RESULT_FILENAME = 'probability_3rd.csv'
...
def read_true_label_from_file():
    ...
    true_labels = [true_label.replace(SEPARATOR_1, '')
...
def build_tree(model_type, prediction, description_dict):
    ...
    # sort subclass data
    subclass_data = dict(sorted(subclass_data.items(),
